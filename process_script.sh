...
then
	...
	wget https://raw.githubusercontent.com/PabloFreitasUfsc/uRos-Projekt/master/Dockerfile
...
then
	...
	cd agent_ws
	wget https://raw.githubusercontent.com/micro-ROS/micro-ROS-doc/develop/Installation/repos/agent_minimum.repos -O micro_ros.repos
...
then
	...
	cd client_ws
	wget https://raw.githubusercontent.com/micro-ROS/micro-ROS-doc/develop/Installation/repos/client_minimum.repos -O micro_ros.repos
	vcs-import src < micro_ros.repos
